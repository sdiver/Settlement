...
jQuery.extend({
	...
	//tabs初始化
	tabs:function(t){ //t:id
		$("#"+t+">ul.card-header-tabs>li>a").click(function(){
			var flag = $(this).attr("show");
			//tab
			$("#"+t+">ul.card-header-tabs>li").each(function(){
				if ($(this).children("a").attr("show") == flag) {
			...
			//contant
			$("#"+t+">div.row>div.card").each(function(){
		...
		//定位到active上
		$("#"+t+">ul.card-header-tabs>li.active>a").click();
	}
});